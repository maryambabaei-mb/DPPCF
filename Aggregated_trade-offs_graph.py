...
from utils.analysis.draw_plots import plot_utility_privacy_tradeoff_3_in_1
...
if __name__ == '__main__':
    ...
    datasets = ['adult'] #,'informs','hospital',,'hospital'
    models = ['RF','NN','SVM']
    ...
    for dataset_name in datasets:
        for model in models:
            # for RANDOM_SEED in range(0,5): 
                ...
                graphs_dir = './dpnice/srr_graphs_dir/{}/{}/'.format(dataset_name,model)
